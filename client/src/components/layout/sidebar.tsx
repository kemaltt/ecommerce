...
export default function Sidebar() {
  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden fixed inset-y-0 left-0 z-50 rounded-none">
      {/* Background Effects */}
      ...
      <div className="flex flex-col flex-1 min-h-0 relative z-10">
        <div className="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
          ...
          <div className="mt-8 px-6">
            <div className="p-4 bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm border border-white/10 rounded-none">
              <div className="flex items-center space-x-3">
